        ...
        "account_lines": [
            {
                ...
                "hwm_source_type": line.hwm_source_type,
...
def invoice_dict(item: Invoice) -> dict:
    ...
    return {
        ...
        "last_issue_status": latest_attempt.status if latest_attempt else None,
        "replacement_invoice_id": item.original_correction.replacement_invoice_id if item.original_correction else None,
        "original_invoice_id": item.replacement_correction.original_invoice_id if item.replacement_correction else None,
        "void_reason": item.void_reason,
        "adjustments": [
